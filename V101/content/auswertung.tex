...
Dafür werden die gemessenen Zeiten gemittelt, und es ergibt sich ein
\begin{align}
I_{\mathrm{gmessen}}=(-0,0004\pm0,0005)\,\si{\kilo\gram\mete\squared}   

 und  aus der Theoretischenformel \eqref{eqn:zs} für
einen Zylinder der parallel zur Drehachse verläuft mit dem Durchmesser
\begin{align}
  d_{z2}=(0.08019\pm0.00011)\,\si{\meter}
\end{align}
berechnet. Diese sind in Tabelle \ref{tab:Zylinder} dargestellt.
\input{content/tabelleBz}
\subsubsection{Kugel}
